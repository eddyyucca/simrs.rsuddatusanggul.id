...
const nama_instansi = 'RS Datu Sanggul'; // Hospital Name
const apiUrl = 'http://rsdatusanggul.id/khanzalite/api/'; // API Server URL
const website_upload = 'http://rsdatusanggul.id/khanzalite/uploads/'; // Website Uploads Server URL
const webapps_url = 'http://rsdatusanggul.id/khanzalite/webapps/'; // Webapps Server URL
const token = 'f13b21ca5929cd7a5b16ac4d0cd0b2f8'; // Token code for security purpose
...
var app  = new Framework7({
  ...
  id: 'com.rsdatusanggul.apam', // App bundle ID
  name: 'APAM RS Datu Sanggul', // App name
  dialog: {
    title: 'Peringatan',
    buttonOk: 'Ya',
    buttonCancel: 'Tidak'
